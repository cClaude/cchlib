...
/**
 * Exception déclanchées par la classe
 *
 * @author Claude CHOISNET
 * @since 3.02.008
 * @version 3.02.008
 */
public class SimpleServletContextException extends javax.servlet.ServletException
{
    ...
    public SimpleServletContextException( final String message )
    {
        super( message );
    }

    public SimpleServletContextException( final Throwable cause )
    {
        super( cause );
    }
}