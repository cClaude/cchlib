...
class ProgressCells extends JFrame
{
    ...
    ProgressCells( final String title )
    {
        ...
        final TableModelListener tml = this::tableChangedTableModelListener;
    ...
    protected void tableChangedTableModelListener( final TableModelEvent event )
    {
        ...
        if( event.getType() == TableModelEvent.UPDATE ) {
            ...
            if( column == 1 ) {
                ...
                // value, if necessary.
                final TableModel tm = (TableModel)event.getSource();
