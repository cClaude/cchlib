...
public class EditResourcesBundleAppI18nPrep implements Runnable
{
    ...
    public void run()
    {
        ...
        final MultiLineEditorDialog.StoreResult storeResult       = new MultiLineEditorDialog.StoreResult(){@Override public void storeResult(final String text) {}};
        ...
        try { Thread.sleep( 1_000 ); } catch( final InterruptedException e ) {} // $codepro.audit.disable emptyCatchClause, logExceptions
