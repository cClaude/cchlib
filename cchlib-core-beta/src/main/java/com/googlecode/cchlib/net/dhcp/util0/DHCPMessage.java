...
public class DHCPMessage {
    ...
    public String printCHAddr() {
            ...
            if (hType == ETHERNET10MB) {
                    str += DHCPUtility.macToString(cHAddr);
            } else {
    ...
    public String toString() {
            ...
            row[3] = "cIAddr: " + DHCPUtility.ip4ToString(cIAddr);
            row[4] = "yIAddr: " + DHCPUtility.ip4ToString(yIAddr);
            row[5] = "sIAddr: " + DHCPUtility.ip4ToString(sIAddr);
            row[6] = "gIAddr: " + DHCPUtility.ip4ToString(gIAddr);
