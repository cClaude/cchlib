 ...
 *
 */
public class DownloadI_milfgalore_tumblr_com
        ...
        implements GenericDownloaderAppInterface
{
    ...
    private final static String __SERVER_ROOT_URL_STR = "http://milfgalore.tumblr.com";

    /**
     * http://milfgalore.tumblr.com/page/2
     */
    private final static String __HTML_URL_BASE_FMT   = __SERVER_ROOT_URL_STR + "/page/%d";

    private static final String SITE_NAME = "milfgalore.tumblr.com";
    private static final int NUMBER_OF_PICTURES_BY_PAGE = 16;
    /** number of pages to explore */
    private final static int DEFAULT_MAX_PAGES = 10;

    /**
     * http://25.media.tumblr.com/tumblr_m7zjbmTlhc1rap1qro1_500.jpg
     */
    //private final static String IMG_URL_BASE_FMT   ="%s";

    private static final String CACHE_FOLDER_NAME = "milfgalore.tumblr.com";


    //private DefaultComboBoxConfig comboBoxConfig;

    public DownloadI_milfgalore_tumblr_com()
    {
        super(
                SITE_NAME,
