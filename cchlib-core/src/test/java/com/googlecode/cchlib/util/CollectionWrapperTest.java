...
{
    private final static Logger logger = Logger.getLogger( CollectionWrapperTest.class );
    ...
    public void before()
    {
        ...
        {
            @Override
            public String wrappe( Integer o ) throws WrappeException
            {
        ...
        {
            @Override
            public Integer wrappe( String o ) throws WrappeException
            {
