 ...
 * @author Claude
 */
public class SerializableTestCaseTest
{
    @BeforeClass
    ...
    public void testClone() throws IOException, ClassNotFoundException
    {
        ...
        MyImpl tst1 = SerializableTestCase.cloneOverSerialization( imp1 );
        ...
        MyInterfaceSerializable tst3 = SerializableTestCase.cloneOverSerialization( imp3 );
