...
public class JavaDBFTest
{
    ...
    public void test3() throws Exception
    {
        ...
        final FileOutputStream fos = new FileOutputStream( getTempFile( "121212.dbf" ) );
        writer.write( fos);
        fos.flush();
        fos.close();
        println( "OK.");
    ...
    public void test4() throws Exception
    {
        ...
        final FileInputStream fis = new FileInputStream( getTempFile( "121212.dbf" ) );
        final DBFReader reader = new DBFReader( fis );
    ...
    public void checkDataType_N() throws Exception
    {
        ...
        writer.setFields( new DBFField[] { field});
        final Double value = new Double( 123456789012345L);
    ...
    public void checkRAFwriting() throws Exception
    {
        ...
        final File file = new File( getTempDirFile(), "raf-1212.dbf" );
