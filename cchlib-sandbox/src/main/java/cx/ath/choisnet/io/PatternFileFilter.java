...
** basée sur le nom du fichier ({@link #accept(File,String)}).
**
...
/**
** Retourne true si le chemin complet du fichier correspont à l'expression
** régulière.
**
...
/**
** Retourne true si le nom du fichier correspont à l'expression
** régulière.
**
** @param dir   Objet File du dossier courant (ignoré)
** @param name  Nom du fichier à tester.
**
...
/**
** Retourne un object {@link java.io.FileFilter}, cette méthode est
** destinée à lever les ambiguitées.
**
...
/**
** Retourne un object {@link java.io.FilenameFilter}, cette méthode est
** destinée à lever les ambiguitées.
**
** @see #asFileFilter()
**
