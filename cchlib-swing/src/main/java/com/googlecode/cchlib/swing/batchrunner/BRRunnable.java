...
public interface BRRunnable extends Serializable
{
     ...
     *
     * @param destinationFolderFile destination folder
     */
     ...
     *
     * @param isCancelled
     *            true if batch has been cancelled, false otherwise
     */
     ...
     *             if output {@link File} can not be created
     */
     ...
     *
     * @param event
     *            a {@link BRExecutionEvent} for current file
     *
     * @throws BRUserCancelException
     *             if {@link BRExecutionEvent} trap an user cancel.
     * @throws BRExecutionException
     *             if batch should be cancel, for any reason.
     */
