...
//            }
//        else {
//            logger.error( "Drag and drop is not supported with this JVM" );
...
//            }
    ...
    public void addDropTargetListener()
    {
        if( dropListener != null ) {
            throw new IllegalStateException( "Already a DropTargetListener" );
            }
...
//    }
    ...
    public boolean remove()
    {
        ...
        return remove( dropTargetComponent, recursive );
    }
     ...
     * @return
     */
    private static boolean remove( Component c, boolean recursive )
    {
        c.setDropTarget( null );
