        ...
        implements TreeCellEditor
{
    ...
    final EmptyDirectoriesTreeModel model;

    /**
     *
     * @param model
     */
    public EmptyDirectoryCheckBoxNodeEditor( final EmptyDirectoriesTreeModel model )
    {
        this.model      = model;
        ...
        ItemListener itemListener = new ItemListener()
        {
            public void itemStateChanged(ItemEvent itemEvent)
            {
                ...
                if (cb instanceof JCheckBox && itemEvent.getStateChange() == ItemEvent.SELECTED) {
                    SimpleTreeNode<File> v = EmptyDirectoryCheckBoxNodeEditor.this.renderer.getCurrentValue();
                    EmptyDirectoryCheckBoxNodeEditor.this.model.toggleState(v);
                    }
