...
/**
** <p>
** Fabrication d'un selectionneur de jour, mois, ann�e localis�.
** </p>
**
** </p>
** Cette classe permet la cr�ation et l'exploitation de formulaires
...
/**
** Lecture du formulaire avec une valeur par d�faut
**
...
/*
** Lecture des donn�e depuis le code HTML, retourne les donn�es sous forme
** de BasicDate.
...
**
** @return un long correspondant � la valeur du gadget.
**
...
/**
** Retourne la valeur sous forme de cha�ne
**
** @return une String correspondant � la valeur du gadget.
**
