...
//    logger.error( "executeQuery( \"" + query + "\" );", e );
//
//    throw e;
//    }
 finally {
...
/**
**
** @return une liste (List) de String contenant les n valeurs trouv�es dans le
...
/**
**
** @return un tableau de String contenant les n valeurs trouv�es � l'aide
**         de la requ�te. Ne retourne jamais null.
**
** @throws java.sql.SQLException
*/
...
{
 if( conn != null ) {
    throw new java.sql.SQLException( "SimpleQuery InvalidState [conn != null]" );
    }

 this.conn = getConnectionFromDataSource(); // getConnection( ds ); // conn = ds.getConnection();
}
