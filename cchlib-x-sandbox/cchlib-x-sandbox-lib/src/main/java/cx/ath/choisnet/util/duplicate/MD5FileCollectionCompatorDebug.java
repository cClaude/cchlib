    ...
    throws Exception
{
 if( args.length == 4 ) {
    ...
    System.err.println( "\tDossierRacineSource DossierSource DossierAMettreAJour DossierTravail" );
...
public static void main( // -----------------------------------------------
    ...
    final File      toUpdateFolderFile,
    final File      tmpFolderFile
    )
    throws Exception
{
 ...
 System.out.println(
            "rootFile = "
                + rootFile + " : " + rootFile.isDirectory()
                );
 System.out.println(
            "sourceFolderFile = "
                + sourceFolderFile + " : " + sourceFolderFile.isDirectory()
                );
 System.out.println(
            "toUpdateFolderFile = "
                + toUpdateFolderFile + " : " + toUpdateFolderFile.isDirectory()
                );
 System.out.println(
            "tmpFolderFile = "
                + tmpFolderFile + " : " + tmpFolderFile.isDirectory()
                );
 System.out.println( "--------------" );
...
public static void main( // -----------------------------------------------
    ...
    final MD5FileCollection toUpdateMD5C,
    ...
    throws Exception
{
 ...
 final MD5FileCollectionCompator cmp
            = new MD5FileCollectionCompator(
                        md5Reference,
                        toUpdateMD5C,
                        new DefaultFileTasksFactory(
                                md5Reference,
                                referenceFolder,
                                toUpdateFolder,
                                tmpFolder
