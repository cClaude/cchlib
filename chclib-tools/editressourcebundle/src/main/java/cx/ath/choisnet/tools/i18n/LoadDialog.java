...
import cx.ath.choisnet.tools.i18n.FilesConfig.FileType;
        ...
        implements ActionListener
{
    ...
    public void actionPerformed( ActionEvent e )
    {
        ...
        if( ACTION_FT_Properties.equals( c )) {
            udpateTabFileTypeDisplay();
            filesConfig.setFileType( FileType.PROPERTIES );
        }
        else if( ACTION_FT_FormattedProperties.equals( c )) {
            udpateTabFileTypeDisplay();
            filesConfig.setFileType( FileType.FORMATTED_PROPERTIES );
        }
