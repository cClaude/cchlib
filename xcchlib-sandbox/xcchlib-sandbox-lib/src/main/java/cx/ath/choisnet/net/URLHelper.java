...
//        }
        ...
        */
        ...
        {
            return "(" + this.contentType + "," + this.contentLength + "," + new java.util.Date( this.date.longValue() ) + ")";
        }
    ...
    public Status download( // ------------------------------------------------
            final URL url, final OutputStream output ) throws java.io.IOException
    {
     ...
     *            URL to copy
     ** @param outputFile
     *            File to create with url content, if URL is found.
     **
     ** @since 3.02.021
     */
    public Status download( // ------------------------------------------------
            final URL url, final File outputFile ) throws java.io.FileNotFoundException, java.io.IOException
    {
...
*/
    public static void copy( // -----------------------------------------------
            final URL url, final Writer output ) throws java.io.IOException
    {
        final Reader input = new BufferedReader( new InputStreamReader( url.openStream() ) );
...
*/
    public static void copy( // -----------------------------------------------
            final URL url, final Writer output, final String charsetName ) // --------------------
            throws java.io.UnsupportedEncodingException, java.io.IOException
    {
        final Reader input = new BufferedReader( new InputStreamReader( url.openStream(), charsetName ) );
