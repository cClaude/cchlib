 ...
 return new Iterator<T>()
 {
        ...
        public boolean hasNext() // - - - - - - - - - - - - - - - - - - - -
        {
            if( nextObject == null ) {
                ...
                //
                // L'objet suivant n'est pas prét, on le prepare
                //
                try {
            ...
            //
            // L'object suivant est prét et valide !
            //
            return true;
        }
        //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
**
** @return un String correspondant é la concaténation des valeurs toString()
**         de l'iterateur donnée. Chaque valeur étant séparée par le contenu
**         de la chaéne 'separator'
**
** @since 1.53.002
**
...
/**
** Construction d'un objet Iterator é partir d'un objet Enumeration
**
** @return  un Iterator equivalent é l'Enumeration donné
**
** @see EnumerationIterator
public static <T> Iterator<T> toIterator( // ------------------------------
...
** </P>
** <br />
** Cette méthode accepte la valeur null pour le paramétre 'array', dans ce
...
/**
** <P>
** Construction d'objet Iterator parcourant les objects du tableau é partir
** de l'indice offset et jusqu'é la position len - 1
** </P>
** <br />
** Cette méthode <b>n'accepte pas</b> la valeur null pour le paramétre 'array'
** <br />
**
** @return  un Iterator sur les objets du tableau de offset et jusqu'é la
**          position len - 1
**
** @see ArrayIterator
public static <T> Iterator<T> toIterator( // ------------------------------
